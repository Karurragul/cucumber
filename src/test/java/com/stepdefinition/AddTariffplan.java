...
public class AddTariffplan  {
	...
	public void the_user_is_in_telecom_Homepage() {
	   ...
	   public void the_user_is_filling_all_the_field(DataTable custdetails) throws Throwable {
		   ...
		   Base.driver.findElement(By.id("rental1")).sendKeys(custdet.get(1).get(3));
		   //
		   Base.driver.findElement(By.id("local_minutes")).sendKeys(custdet.get(2).get(2));
		   //
		   Base.driver.findElement(By.id("inter_minutes")).sendKeys(custdet.get(0).get(1));
		   //
		   Base.driver.findElement(By.id("sms_pack")).sendKeys(custdet.get(1).get(4));
		   //
		   Base.driver.findElement(By.id("minutes_charges")).sendKeys(custdet.get(3).get(2));
		   //
		   Base.driver.findElement(By.id("inter_charges")).sendKeys(custdet.get(2).get(1));
		   //
		   Base.driver.findElement(By.id("sms_charges")).sendKeys(custdet.get(0).get(2));
